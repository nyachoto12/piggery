...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-row">
  ...
  <a href="addProduct.php" class="btn btn-sm btn-primary pull-right"><i class="fa fa-plus"></i> Add New Product</a><br><br>
 <div class="table-responsive">
 	<table class="table table-hover table-striped" id="table">
        ...
        <th></th>
 		...
 		<tbody>
 			<?php
       $all_product = $db->query("SELECT * FROM products ORDER BY id DESC");
       $fetch = $all_product->fetchAll(PDO::FETCH_OBJ);
       foreach($fetch as $data){ 
          $get_category = $db->query("SELECT * FROM category WHERE id = '$data->category_id'");
          $category_result = $get_category->fetchAll(PDO::FETCH_OBJ);
            ...
            <td>
               <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a onclick="return confirm('Continue quarantine product ?')" href="quarantine.php?id=<?php echo $data->id; ?>"><i class="fa fa-paper-plane"></i> Quarantine product</a></li>
                  </ul>
                </div> 
            </td>
          </tr>    
